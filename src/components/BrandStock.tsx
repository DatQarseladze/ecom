...
const PromotionBanner = () => {
  return (
    <Box
      className="xl:px-[168px]  bg-[#E9EBF8] flex flex-row justify-between lg:flex-row items-center"
      sx={{ height: "652px" }}
    >
      <div className=" lg:w-1/2 flex flex-col px-auto justify-center text-center lg:text-left">
        ...
        <button className=" flex items-center text-[16px] max-w-max text-[#fff] text-[20px] leading-[28px] rounded-[8px] p-[16px] bg-[#8255E3] hover:bg-[#7143D1]">
          გაიგე მეტი
