...
const Map = ({ hidePagination = false, mapHeight = "704px", hideImage = false }) => {
  ...
  return (
    <div>
      <div className="flex flex-col gap-[16px]">
        ...
        <div className="flex gap-[8px] pb-[24px]">
          <DropdownSelect
            attribute="name"
          ...
          >
            <div className="flex items-center gap-[8px]">
              ...
              />
              <span className="text-[#474D66] text-nowrap"> 24 საათიანი</span>
            </div>
            <div className="flex items-center gap-[8px]">
              <Checkbox
              ...
              />
              <span className="text-[#474D66] text-nowrap">ღიაა ახლა</span>
            </div>
          </div>
        </div>
      </div>
