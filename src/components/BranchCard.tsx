        ...
        <div className="relative min-w-[52px]" ref={phoneIconRef}>
          ...
          {showPopup && (
            <div
              ...
              className="absolute border-[1px] border-solid border-[#1B1D200F] top-[30px] left-[25px] transform -translate-x-[50%] shadow-lg rounded-lg px-[15px] py-[11px] bg-[#fff] z-[9999] whitespace-nowrap hover:bg-[#f5f5f5] active:bg-[#e0e0e0]"
            >
              <span
                onClick={() => {
