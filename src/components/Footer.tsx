...
const Footer = () => {
  ...
  return (
    ...
    >
      <div className="flex justify-between items-center 2xl:mx-[168px] max-2xl:mx-[168px] mx-auto pt-[48px] pb-[47px]">
      ...
      />
      <div className="2xl:mx-[168px] max-2xl:mx-[168px] mx-auto">
